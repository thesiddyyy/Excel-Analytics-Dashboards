...
4. Analyze charts and KPIs to extract insights  
...
- Tracks delivered, cancelled, and returned orders  
...
Developed an interactive Excel sales dashboard using pivot tables, charts, and slicers to analyze sales trends, customer demographics, and channel performance for Vrinda Store.
